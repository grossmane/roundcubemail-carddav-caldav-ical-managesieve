...
class calendar_ui
{
  ...
  public function addJS()
  {
    ...
    $this->cal->include_script('lib/oauth-client.js');
  ...
  function priority_select($attrib = array())
  {
    ...
    $select = new html_select($attrib);
    $select->add('---', '0');
    $select->add($this->cal->gettext('highest'), '1');
    $select->add($this->cal->gettext('high'),    '2');
    /*
    $select->add('3 ',                                '3');
    $select->add('4 ',                                '4');
    */
    $select->add($this->cal->gettext('normal'),  '5');
    /*
    $select->add('6 ',                                '6');
    $select->add('7 ',                                '7');
    */
    $select->add($this->cal->gettext('low'),     '8');
    $select->add($this->cal->gettext('lowest'),  '9');
    return $select->show(null);
  }
