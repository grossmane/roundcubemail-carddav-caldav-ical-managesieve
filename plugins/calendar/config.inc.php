...
$config['calendar_driver'] = array("caldav","ical","database");
...
// Use "https://<your domain>/?_task=calendar&_action=oauth_handle_callback" as authroized redurect URI when
// creating your Google OAuth2 credentials.
//
//    "key" => array(
//        "name" => "Google OAuth2 Provider",
//        "scope" => "https://www.googleapis.com/auth/calendar",
//        "json" => "/path/to/client_id.json"
//    ),
...
// Caldav driver is supported only
 $config['calendar_preinstalled_calendars'] = array(
    'User' => array(
                    ...
                    'caldav_user' => '%u',
                    'caldav_pass' => '%p',
                    'caldav_url'  => 'http://radicale:5232/%u/calendar.ics/',
                    'color'       => '0000CD',
                    'showAlarms'  => 1),
    'Group' => array(
                    'name'        => 'Group',
                    ...
                    'caldav_user' => '%u',
                    'caldav_pass' => '%p',
                    'caldav_url'  => 'http://radicale:5232/group/calendar.ics/',
                    'color'       => '2E8B57',
                    'showAlarms'  => 1));
?>
